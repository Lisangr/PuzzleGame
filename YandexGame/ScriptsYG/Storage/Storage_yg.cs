...
namespace YG
{
    public partial class YandexGame
    {
        ...
        public static void LoadEditor()
        {
            ...
            string path = Application.persistentDataPath + PATH_SAVES_EDITOR;
            ...
            string currentLanguage = Application.systemLanguage.ToString().ToLower();

            switch (currentLanguage)
            {
                case "russian":
                    EnvironmentData.language = "ru";
                    break;
                case "english":
                    EnvironmentData.language = "en";
                    break;
                default:
                    EnvironmentData.language = "en";
                    break;
